// SMSC.RU API (smsc.ru) версия 3.0 (31.01.2017)
using System;
using System.Web;
using System.Net;
using System.IO;
...
namespace SMSC_API
{
    public class SMSC
    {
        ...
        const string SMSC_LOGIN = "zzzkasper-1995";          // логин клиента
        const string SMSC_PASSWORD = "iampasforsmsc2017";    // пароль или MD5-хеш пароля в нижнем регистре
        ...
        private void _print_debug(string str)
        {
            ...
            Console.WriteLine("SMSC_warning:" + str);
        }
    }
}

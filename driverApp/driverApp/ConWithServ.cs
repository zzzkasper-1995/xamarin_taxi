...
namespace Cheesesquare
{
    ...
    public class ConWithServ
    {
        ...
        public static Response newOrder(string move, string dep, string arr, string num, string comment, string companion) //создание заказа 
        {
            string dataToSend;
            Response response;
            try
        ...
        public static Response getStateOrder()// получить состояние заказа
        {
            string dataToSend;
            Response response;
            try
        ...
        public static Response setOption(string surname, string name, string city)//отправка настроек клиента на сервер
        {
            string dataToSend;
            Response response;
            try
